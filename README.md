...
1. Use "CTRL+SHIFT+X" or Click on "File" -> Preferences -> Extensions
2. Search for "Live Server" and install it.

# Launching instructions:

1. Using CMD or Powershell, run "npm i"
2. Right click "index.html" and click on "Open with Live Server"
